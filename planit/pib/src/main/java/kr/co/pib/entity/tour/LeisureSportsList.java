...
@Entity
@Table(name = "leisure_sports_list")
@Getter
@Setter
@Builder
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@AllArgsConstructor
public class LeisureSportsList {
    ...
    @Column(name = "open_term", length = 500)
    private String openTerm; // 개장기간

    @Column(name = "usetime", length = 500)
    private String usetime; // 이용시간

    @Column(name = "enter_cost", length = 500)
    ...
    @Column(name = "parking_cost", length = 500)
